                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @csrf
                                        <div class="row">
                                            <x-input type="text" name="subject" label="Subject" value="Receipt Generated" />
                                            <x-input type="text" name="from" label="From Name" value="{{ ($admin)?$admin->name:'' }}" />
                                            <x-input type="text" name="to" label="To :" value="{{ ($funder)?$funder->funder_email:'' }}" />
                                            ...
                                            <div class="col-md-12 col-12">
                                                ...
                                                <label for="message-column">Message</label>
                                                    <textarea name="body" id="default" cols="30" rows="15"></textarea>
